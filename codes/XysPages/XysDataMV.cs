...
namespace ASPNETCoreWeb.codes.XysPages
{
    ...
    public class XysDataMV : WebBase
    {
        ...
        public XysDataMV()
        {
            ...
            int pageNoVal = (int)Common.Val(ParamValue("DataGrid_PageNo"));
            ...
            Translator.Format("dataid"),
            Translator.Format("dataname"),
            Translator.Format("datadesc"),
        ...
        public override string InitialViewHtml()
        {
            ...
            filterBtn.SetAttribute(HtmlEvents.onclick, ByPassCall("XysDataMV/SearchClicked"));
        ...
        private void SetGridStyle(SQLGridSection SQLGrid)
        {
            ...
            if (SQLGrid.GridData != null)
            {
                ...
                SQLGrid.Grid.TableColumns[3].SetColumnFormat("@D {3} |" + LocalDateTimeFormat);
        ...
        public ApiResponse SearchClicked()
        {
            ...
            SQLGridInfo.Query.Filters = "DataName + DataDesc like N'%" + FilterBoxValue + "%' ";
            SQLGridSection SQLGrid = new SQLGridSection(SQLGridInfo);
            if (SQLGrid.Grid != null)
            {
                SQLGrid.Grid.Table.SetAttribute(HtmlAttributes.@class, "tableX");
